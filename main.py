...
"""
Null Hunters Slot Bot

Desarrollado por: @Fb1.i
Comunidad: Null Hunters™
...
Notas:
- Cambia las reglas del slot en el mensaje enviado dentro de setslot().
- Cambia el maximo de @here y @everyone desde los limites en los comandos here/everyone.
- Configura token, owners, prefix y categoria en config.json.
"""
